--FUN��ES DE TEXTO NO SQL SERVER - Parte 02
--Aula 18

--Fun��es: FORMAT, LEFT, RIGHT, LEN, LOWER, UPPER
--Coment�rio em Bloco
...
select format(at.valor, 'N', 'en-US') Formato_Americano, 
	   ...
	   format(at.valor, 'C', 'de-de') Formato_Monetario_DE,
	   format(at.valor, 'C', 'de-at') Formato_Monetario_AUT
...
select right('Este � um curso de SQL', 12);
