...
--Insert com descri��o dos campos
...
---------------------------------------------
--INSERT com a descri��o dos campos
-- Exemplo 1
...
select * from dbo.alunos WHERE id_aluno > 790;
...
VALUES
    (12, 'VBA Avançado I', getdate(), 'REICH');
...
INSERT INTO Cursos
      (id_curso, nome_curso, data_cadastro, login_cadastro)
VALUES
      (@vID, 'VBA Avançado II', getdate(), 'REICH');
