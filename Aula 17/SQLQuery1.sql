--FUN��ES DE TEXTO NO SQL SERVER - Parte 01
--Aula 17

--Fun��es: ASCII, NCHAR, CHAR, CHARINDEX, CONCAT, CONCAT_WS, DIFFERENCE
...
--NCHAR (Converte um c�dicgo Ascii do tipo int em um valor de caracter)
select nchar(65);
select nchar(97);
select nchar(50);

--CHAR (Converte um c�dicgo Ascii do tipo int em um valor de caracter)
select char(65);
select char(97);
